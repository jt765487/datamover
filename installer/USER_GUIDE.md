...
5. **Review Bitmover (including Purger) Configuration (Recommended):**
   ...
   `[Purger]` sections, to suit your environment's PCAP generation rate and disk capacity. See Appendix A.4 for details.
...
3. **Verify Configuration:**
    ...
    * Bitmover config (including Purger): `/etc/exportcliv2/config.ini` (See Appendix A.4).
